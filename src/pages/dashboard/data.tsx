          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <defs id="defs50">
              ...
              <linearGradient
                ...
                gradientTransform="matrix(.07142 0 0 .07142 1.3398 1.8944)"
              >
                <stop stopColor="#ffffff" id="stop43"></stop>
                <stop offset=".0833" stopColor="#ffffff" id="stop45"></stop>
                <stop offset="1" stopColor="#ffffff" id="stop47"></stop>
              </linearGradient>
            </defs>
          </g>
        </svg>
    ...
    },
    {
      ...
      logo: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="#000000">
          ...
          <line x1="208" y1="128" x2="128" y2="208" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32"></line>
          <line x1="192" y1="40" x2="40" y2="192" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32"></line>
        </svg>
      ),
    },
    {
